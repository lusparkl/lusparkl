### Hi there! <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExeHdpNDYwNHJkbDZ3bWdraHpjdXlrdzEzaDRpZ2w1OWpjaHAwbjJ6bCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/wtdVYmaRWJ1PyPcc8e/giphy.gif" width="25"/> 

I’m **lusparkl**, a Python dev based in Ukraine. I like building something that's hella cool and may be useful, AI agents is my new love.

**These days I’m focused on:**
- Langchain, Machine Learning and Electronics
- Learning German(that's hard though)
- Build and learn as much as I can before uni.
...
- [tik-tok-streak-saver](https://github.com/lusparkl/tik-tok-streak-saver) - CLI app that will save your tik tok streaks and let you to forget about it for some time. In development rn.
- [notee](https://github.com/lusparkl/notee) - CLI app to make your notes in the console. Btw there is also ai module in there, search notes with vector db and so on.
